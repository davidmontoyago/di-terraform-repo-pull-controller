...
import (
	...
	scheme "github.com/davidmontoyago/di-terraform-repo-pull-controller/pkg/generated/clientset/versioned/scheme"
...
type RepoInterface interface {
	...
	UpdateStatus(*v1alpha1.Repo) (*v1alpha1.Repo, error)
...
func (c *repos) UpdateStatus(repo *v1alpha1.Repo) (result *v1alpha1.Repo, err error) {
	result = &v1alpha1.Repo{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("repos").
