...
func (c *FakeRepos) Get(name string, options v1.GetOptions) (result *v1alpha1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(reposResource, c.ns, name), &v1alpha1.Repo{})
...
func (c *FakeRepos) List(opts v1.ListOptions) (result *v1alpha1.RepoList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(reposResource, reposKind, c.ns, opts), &v1alpha1.RepoList{})
	...
	list := &v1alpha1.RepoList{ListMeta: obj.(*v1alpha1.RepoList).ListMeta}
...
func (c *FakeRepos) Watch(opts v1.ListOptions) (watch.Interface, error) {
	return c.Fake.
		InvokesWatch(testing.NewWatchAction(reposResource, c.ns, opts))
...
func (c *FakeRepos) Create(repo *v1alpha1.Repo) (result *v1alpha1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(reposResource, c.ns, repo), &v1alpha1.Repo{})
...
func (c *FakeRepos) Update(repo *v1alpha1.Repo) (result *v1alpha1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(reposResource, c.ns, repo), &v1alpha1.Repo{})
...
func (c *FakeRepos) UpdateStatus(repo *v1alpha1.Repo) (*v1alpha1.Repo, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(reposResource, "status", c.ns, repo), &v1alpha1.Repo{})
...
func (c *FakeRepos) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(reposResource, c.ns, name), &v1alpha1.Repo{})
...
func (c *FakeRepos) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	action := testing.NewDeleteCollectionAction(reposResource, c.ns, listOptions)
...
func (c *FakeRepos) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Repo, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(reposResource, c.ns, name, pt, data, subresources...), &v1alpha1.Repo{})
