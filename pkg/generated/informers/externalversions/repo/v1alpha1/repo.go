...
import (
	...
	v1alpha1 "github.com/davidmontoyago/di-terraform-repo-pull-controller/pkg/generated/listers/repo/v1alpha1"
...
func NewRepoInformer(client versioned.Interface, namespace string, resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredRepoInformer(client, namespace, resyncPeriod, indexers, nil)
}
...
func (f *repoInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredRepoInformer(client, f.namespace, resyncPeriod, cache.Indexers{cache.NamespaceIndex: cache.MetaNamespaceIndexFunc}, f.tweakListOptions)
}

func (f *repoInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&repov1alpha1.Repo{}, f.defaultInformer)
}

func (f *repoInformer) Lister() v1alpha1.RepoLister {
	return v1alpha1.NewRepoLister(f.Informer().GetIndexer())
}
